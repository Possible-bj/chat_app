        ...
        function (e, r, t) {
            ...
            s = function (e, r, t) {
              if (e) {
                ...
                if (a) {
                  if (
                    !t.plainObjects &&
                    h.call(Object.prototype, a) &&
                    !t.allowPrototypes
                  )
                    return
                  c.push(a)
                }
                for (var l = 0; null !== (i = n.exec(o)) && l < t.depth; ) {
                  if (
                    ((l += 1),
                    !t.plainObjects &&
                ...
                return (
                  ...
                  (function (e, r, t) {
                    for (var o = r, n = e.length - 1; 0 <= n; --n) {
                      var i,
                        a = e[n]
                      if ('[]' === a && t.parseArrays) i = [].concat(o)
                      else {
          ...
          r.exports = function (e, r) {
            ...
            if (
              ...
              (t.delimiter =
                'string' == typeof t.delimiter || y.isRegExp(t.delimiter)
                  ? t.delimiter
                  : m.delimiter),
              (t.depth = 'number' == typeof t.depth ? t.depth : m.depth),
              (t.arrayLimit =
                'number' == typeof t.arrayLimit ? t.arrayLimit : m.arrayLimit),
              (t.parseArrays = !1 !== t.parseArrays),
              (t.decoder =
                'function' == typeof t.decoder ? t.decoder : m.decoder),
              (t.allowDots =
                void 0 === t.allowDots ? m.allowDots : !!t.allowDots),
              (t.plainObjects =
            ...
            if (
              (void 0 === t.charset && (t.charset = m.charset),
              '' === e || null == e)
            )
                    ...
                    ? (function (e, r) {
                        ...
                        for (t = 0; t < a.length; ++t)
                          if (t !== c) {
                            ...
                            ;(f =
                              -1 === d
                                ? ((s = r.decoder(u, m.decoder, l)),
                                  r.strictNullHandling ? null : '')
                                : ((s = r.decoder(u.slice(0, d), m.decoder, l)),
                                  r.decoder(u.slice(d + 1), m.decoder, l))) &&
                              r.interpretNumericEntities &&
                              'iso-8859-1' === l &&
                              (f = f.replace(/&#(\d+);/g, function (e, r) {
      ...
      4: [
        function (e, r, t) {
          ...
          var x = e('./utils'),
            ...
            E = function e(r, t, o, n, i, a, c, l, s, f, u, p, d) {
              var y = r
              if (
                ('function' == typeof c
                  ? (y = c(t, y))
                  : y instanceof Date && (y = f(y)),
                null === y)
              ) {
                if (n) return a && !p ? a(t, C.encoder, d) : t
                y = ''
              }
              if (
                'string' == typeof y ||
              ...
              for (var g = 0; g < h.length; ++g) {
                ...
                ;(i && null === y[v]) ||
                  (Array.isArray(y)
                    ? P(m, e(y[v], o(t, v), o, n, i, a, c, l, s, f, u, p, d))
                    : P(
                        m,
                        e(
                          y[v],
          ...
          r.exports = function (e, r) {
            ...
            var n = void 0 === o.delimiter ? C.delimiter : o.delimiter,
              i =
            ...
            if (void 0 === o.format) o.format = N.default
              ...
              !Object.prototype.hasOwnProperty.call(N.formatters, o.format)
            )
              throw new TypeError('Unknown format option provided.')
            var y,
              h,
              m = N.formatters[o.format]
            'function' == typeof o.filter
              ? (t = (h = o.filter)('', t))
              : Array.isArray(o.filter) && (y = h = o.filter)
            var b,
              g = []
            ...
            for (var O = 0; O < y.length; ++O) {
              var j = y[O]
              ;(a && null === t[j]) ||
                P(g, E(t[j], j, v, i, a, c ? l : null, h, s, f, u, m, p, d))
            }
            var w = g.join(n),
          ...
          r.exports = {
            ...
            compact: function (e) {
              for (
                ...
                for (
                  var n = r[o], i = n.obj[n.prop], a = Object.keys(i), c = 0;
                  c < a.length;
                  ++c
                ) {
                  var l = a[c],
            ...
            merge: function o(t, n, i) {
              ...
              var e = t
              return (
                Array.isArray(t) && !Array.isArray(n) && (e = l(t, i)),
                Array.isArray(t) && Array.isArray(n)
                  ...
                  : Object.keys(n).reduce(function (e, r) {
                      var t = n[r]
                      return (
                        a.call(e, r) ? (e[r] = o(e[r], t, i)) : (e[r] = t), e
                      )
                    }, e)
              )
            },
